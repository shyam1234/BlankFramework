...
public class WardFragment1 extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AppLog.log("WardFragment1","onCreate");
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AppLog.log("WardFragment1","onCreateView");
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        AppLog.log("WardFragment1","onActivityCreated");
        initView();
    }
    ...
    private void setDefaultStudentProfileInHeader(boolean isLoadFirstTime, int position) {
        ...
        if(isLoadFirstTime) {
            ...
            AppLog.networkLog("WardFragment1 networkLog.networkLog  ", "" + UserInfo.authToken);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imageview_profile_eye:
                ...
                Utils.navigateWardFragment(getFragmentManager(),new ProfileFragment(),TAG);
                break;
            case R.id.fab_edit:
                Toast.makeText(getContext(), "Coming soon", Toast.LENGTH_SHORT).show();
                break;
